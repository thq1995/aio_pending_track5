...
ap.add_argument("-v", "--input_video_dir", help="path to input video dir", default="data/aicity2024_track5_test/videos/")
...
def main():
    ...
    # generate label
    # for file in tqdm(sorted(os.listdir(output_video_dir)):
